...
export default function Home() {
  ...
  return (
    <div className="dark bg-gray-950 text-gray-100 min-h-screen flex flex-col items-center">
      {/* Navbar */}
      <nav className="w-full flex justify-between items-center px-6 py-4 bg-gray-900 border-b border-gray-800 sticky top-0 z-50">
      ...
      {/* Mobile Dropdown */}
      {isOpen && (
        <div className="w-full bg-gray-900 border-b border-gray-800 md:hidden">
      ...
      <section
        id="home"
        className="flex flex-col items-center justify-center flex-1 text-center py-20 px-4"
      >
        <motion.h2
      ...
      {/* The rest of your Freelancer, Experience, Projects, Skills, Education, Contact, Footer */}
      {/* Add `px-4` in sections for mobile spacing, and grid → stack on small screens */}
